...
public class IonHeaderItemImpl extends ASTWrapperPsiElement implements IonHeaderItem {

  public IonHeaderItemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IonVisitor visitor) {
    visitor.visitHeaderItem(this);
  }
