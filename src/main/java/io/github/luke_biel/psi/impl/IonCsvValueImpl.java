...
public class IonCsvValueImpl extends ASTWrapperPsiElement implements IonCsvValue {

  public IonCsvValueImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public IonCsvDictionaryItem getCsvDictionaryItem() {
    return findChildByClass(IonCsvDictionaryItem.class);
  }
