...
public class IonCsvImpl extends ASTWrapperPsiElement implements IonCsv {

  public IonCsvImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<IonCsvValues> getCsvValuesList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, IonCsvValues.class);
  }
